DELETE FROM trainingEntities;
DELETE FROM trainees;
DELETE FROM trainerEntities;
DELETE FROM users;
...
INSERT INTO trainerEntities (trainer_id, user_id, training_type_id) VALUES (nextval('trainers_SEQ'), (SELECT user_id FROM users WHERE user_name = 'Ivan.Ivanov'), (SELECT training_type_id FROM training_types WHERE training_type = 'CARDIO'));
INSERT INTO trainerEntities (trainer_id, user_id, training_type_id) VALUES (nextval('trainers_SEQ'), (SELECT user_id FROM users WHERE user_name = 'Petr.Petrov'), (SELECT training_type_id FROM training_types WHERE training_type = 'STRENGTH'));
